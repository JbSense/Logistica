...
CREATE TABLE `cds` (
  ...
  CONSTRAINT `cds_ibfk_1` FOREIGN KEY (`id_endereco`) REFERENCES `enderecos` (`id_endereco`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `cds` VALUES (1,'Logbia','55107206000107',2,'2022-07-11 21:55:26','2022-07-11 21:55:26');
...
-- Dump completed on 2022-07-11 19:08:06
